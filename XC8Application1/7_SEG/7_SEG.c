...
#include <C:/Users/Diefco/Desktop/XC8Application1/AVR_3almny_academy/XC8Application1/DIO/DIO.h>
#include <C:/Users/Diefco/Desktop/XC8Application1/AVR_3almny_academy/XC8Application1/DIO/std_macros.h>

void seven_SEG_initialize(unsigned char port){
	DIO_set_dir(port,0xff);
}

void seven_SEG_initialize_least4bit(unsigned char port){
...
void seven_SEG_initialize_most4bit(unsigned char port){
	DIO_set_bit_dir(port,4,1);
	DIO_set_bit_dir(port,5,1);
	DIO_set_bit_dir(port,6,1);
	DIO_set_bit_dir(port,7,1);
}
